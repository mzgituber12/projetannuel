...
func main() {
	...
	http.HandleFunc("/load-contacts-block", ressources.LoadContactsBlock(db))
	http.HandleFunc("/load-contacts-send", ressources.LoadContactsSend(db))
	http.HandleFunc("/load-contacts-get", ressources.LoadContactsGet(db))
	http.HandleFunc("/send-message", ressources.SendMessage(db))
	http.HandleFunc("/add-contact", ressources.AddContact(db))
	http.HandleFunc("/delete-contact/{id}", ressources.DeleteContact(db))
	http.HandleFunc("/block-contact/{id}", ressources.BlockContact(db))
	http.HandleFunc("/deblock-contact/{id}", ressources.DeblockContact(db))
	http.HandleFunc("/remove-demand/{id}", ressources.RemoveDemand(db))
	http.HandleFunc("/deny-demand/{id}", ressources.DenyDemand(db))
	http.HandleFunc("/accept-demand/{id}", ressources.AcceptDemand(db))
	...
	http.HandleFunc("/conseils-note", ressources.ConseilNote(db))
	http.HandleFunc("/annuler-note", ressources.AnnulerNote(db))
	...
	http.HandleFunc("/prestataire/factures/{id}/pdf_archive", ressources.TelechargerArchivePDFFacturePrestataire(db))
	...
	http.HandleFunc("/prestataire/mes_services", ressources.Prestataire_mes_services_collection(db))
	http.HandleFunc("/prestataire/mes_services/{id}", ressources.Prestataire_mes_services_item(db))
	http.HandleFunc("/prestataire/categorie", ressources.Creer_categorie_prestataire(db))
	...
	http.HandleFunc("/admin/facture_prestataire/{id}/pdf_archive", ressources.TelechargerArchivePDFFactureAdmin(db))
