...
function renderFactures() {
    ...
    factures.forEach((f, idx) => {
        ...
        html += '<div><span class="badge text-bg-light me-2">Generation: ' + esc(f.date_generation || '-') + '</span><span class="badge text-bg-secondary">Prestations: ' + interventions.length + '</span></div>';
