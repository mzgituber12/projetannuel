...
<h1 class="mt-5 mb-4">Détail du conseil</h1>
<div class="container-lg" id="conseilDetail">Chargement...</div>
    ...
    container.innerHTML = `
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <a class="btn btn-primary" href="conseils.php">Retour à la page conseils</a>
            </div>
        </div>
    `;
}
