...
<div class="d-flex justify-content-center">
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="mb-3">
                <label for="post" class="form-label">L'abonnement sera pour :</label>
            ...
            <div class="mb-3 position-relative">
                <label for="Titre" class="form-label">Nom de l'abonnement</label>
                <div class="d-flex">
            ...
            <div class="mb-3 position-relative">
                <label for="prixmois" class="form-label">Prix/mois</label>
                <div class="d-flex">
            ...
            <div class="mb-3 position-relative">
                <label for="prixan" class="form-label">Prix/an</label>
                <div class="d-flex">
            ...
            <div class="mb-3">
                <label for="post" class="form-label text-danger">Définir le nombre d'avantage :</label>
            ...
            <div class="mb-3 position-relative">
                <label for="prixan" class="form-label">Ajouter Avantage/inconveniant</label>
                <div class="d-flex">
...
async function nombre_avantage() {
    ...
    const ajout_champ_avantage = document.getElementById("avantage");
    const ajout_champ_inconveniant = document.getElementById("inconveniant");
