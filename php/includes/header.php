...
async function headerUser(token) {
    ...
    if (data.message == "Identifié"){
        ...
        if (data.role == "adherant"){
            ...
            document.getElementById("header").innerHTML += " | <a href='gestion_user.php'>Gestion des Utilisateur</a> | <a href='gestion_evenement.php'>Gestion des Evenements</a>  | <a href='gestion_service.php'>Gestion des Services</a> | <a href='gestion_intervention.php'>Gestion des Interventions</a> | <a href='gestion_article.php'>Gestion des Articles</a> | <a href='gestion_conseils.php'>Gestion des Conseils</a>  | <a href='gestion_notifs.php'>Gestion des Notifications</a>  | <a href='gestion_finance.php'>Gestion Financiere</a> | <a href='gestion_contact.php'>Gestion des contacts</a>";
        }
